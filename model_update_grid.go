...
// checks if the UpdateGrid type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGrid{}
...
func (o UpdateGrid) ToMap() (map[string]interface{}, error) {
