...
// checks if the BranchDiffCell type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BranchDiffCell{}
...
func (o BranchDiffCell) ToMap() (map[string]interface{}, error) {
