...
*PublicDependencyApi* | [**Create**](docs/PublicDependencyApi.md#create) | **Post** /v1/views/{viewId}/dependencies | create
*PublicDependencyApi* | [**Delete**](docs/PublicDependencyApi.md#delete) | **Delete** /v1/views/{viewId}/dependencies | delete
*PublicDependencyApi* | [**Delete_0**](docs/PublicDependencyApi.md#delete_0) | **Delete** /v1/views/{viewId}/dependencies/{dependencyId} | delete
*PublicDependencyApi* | [**Get**](docs/PublicDependencyApi.md#get) | **Get** /v1/views/{viewId}/dependencies/{dependencyId} | get
*PublicDependencyApi* | [**List**](docs/PublicDependencyApi.md#list) | **Get** /v1/views/{viewId}/dependencies | list
*PublicDependencyApi* | [**Update**](docs/PublicDependencyApi.md#update) | **Put** /v1/views/{viewId}/dependencies/{dependencyId} | update
...
## Documentation For Models
 ...
 - [PublicDependency](docs/PublicDependency.md)
