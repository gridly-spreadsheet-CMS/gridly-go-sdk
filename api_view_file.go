...
func (r ViewFileApiApiDownloadRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
func (a *ViewFileApiService) DownloadExecute(r ViewFileApiApiDownloadRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
func (r ViewFileApiApiUploadRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ViewFileApiService) UploadExecute(r ViewFileApiApiUploadRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
func (r ViewFileApiApiUploadZipRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ViewFileApiService) UploadZipExecute(r ViewFileApiApiUploadZipRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
