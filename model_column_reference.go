...
// checks if the ColumnReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ColumnReference{}
...
func (o ColumnReference) ToMap() (map[string]interface{}, error) {
