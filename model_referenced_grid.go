...
// checks if the ReferencedGrid type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReferencedGrid{}
...
func (o ReferencedGrid) ToMap() (map[string]interface{}, error) {
