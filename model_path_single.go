...
// checks if the PathSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PathSingle{}
...
func (o PathSingle) ToMap() (map[string]interface{}, error) {
