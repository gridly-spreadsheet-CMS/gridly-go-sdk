...
type GridApiApiCreateRequest struct {
	...
	dbId *string
	createCompositeGrid *CreateGrid
}
...
// createCompositeGrid
func (r GridApiApiCreateRequest) CreateCompositeGrid(createCompositeGrid CreateGrid) GridApiApiCreateRequest {
	r.createCompositeGrid = &createCompositeGrid
	return r
}
...
func (a *GridApiService) CreateExecute(r GridApiApiCreateRequest) (Grid, *_nethttp.Response, error) {
	...
	if r.createCompositeGrid == nil {
		return localVarReturnValue, nil, reportError("createCompositeGrid is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createCompositeGrid
	if r.ctx != nil {
...
type GridApiApiUpdateRequest struct {
	...
	ApiService *GridApiService
	gridId string
	updateCompositeGrid *UpdateGrid
}

// updateCompositeGrid
func (r GridApiApiUpdateRequest) UpdateCompositeGrid(updateCompositeGrid UpdateGrid) GridApiApiUpdateRequest {
	r.updateCompositeGrid = &updateCompositeGrid
	return r
}
...
func (a *GridApiService) UpdateExecute(r GridApiApiUpdateRequest) (Grid, *_nethttp.Response, error) {
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.updateCompositeGrid == nil {
		return localVarReturnValue, nil, reportError("updateCompositeGrid is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateCompositeGrid
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
