...
// checks if the DeletePath type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeletePath{}
...
func (o DeletePath) ToMap() (map[string]interface{}, error) {
