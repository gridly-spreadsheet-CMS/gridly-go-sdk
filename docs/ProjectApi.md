...
func main() {
    createProject := *openapiclient.NewCreateProject("Name_example") // CreateProject | createProject
...
> Project FindOne(ctx, projectId).Execute()
...
func main() {
    projectId := int64(789) // int64 | projectId
    updateProject := *openapiclient.NewUpdateProject("Name_example") // UpdateProject | updateProject
