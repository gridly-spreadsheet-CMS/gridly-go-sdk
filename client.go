...
// APIClient manages communication with the Gridly API API v3.20.0
...
type APIClient struct {
	...
	PublicDependencyApi *PublicDependencyApiService

	RecordApi *RecordApiService

	TaskApi *TaskApiService

	VersionControlApi *VersionControlApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PublicDependencyApi = (*PublicDependencyApiService)(&c.common)
	c.RecordApi = (*RecordApiService)(&c.common)
	c.TaskApi = (*TaskApiService)(&c.common)
	c.VersionControlApi = (*VersionControlApiService)(&c.common)
