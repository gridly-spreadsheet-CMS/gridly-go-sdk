...
// checks if the FileCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileCategory{}
...
func (o FileCategory) ToMap() (map[string]interface{}, error) {
...
func (v NullableFileCategory) Get() *FileCategory {
	return v.value
}
...
func NewNullableFileCategory(val *FileCategory) *NullableFileCategory {
	return &NullableFileCategory{value: val, isSet: true}
}
