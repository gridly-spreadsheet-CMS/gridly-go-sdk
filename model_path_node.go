...
// checks if the PathNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PathNode{}
...
func (o PathNode) ToMap() (map[string]interface{}, error) {
