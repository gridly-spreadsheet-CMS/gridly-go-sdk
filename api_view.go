...
func (r ViewApiApiExportRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
func (a *ViewApiService) ExportExecute(r ViewApiApiExportRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
