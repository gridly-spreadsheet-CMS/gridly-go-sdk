...
type ViewApiApiCreateRequest struct {
...
// createView
func (r ViewApiApiCreateRequest) CreateView(createView CreateView) ViewApiApiCreateRequest {
	r.createView = &createView
	return r
}

func (r ViewApiApiCreateRequest) Execute() (View, *_nethttp.Response, error) {
...
Create create
 ...
 @return ViewApiApiCreateRequest
*/
func (a *ViewApiService) Create(ctx _context.Context) ViewApiApiCreateRequest {
	return ViewApiApiCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return View
func (a *ViewApiService) CreateExecute(r ViewApiApiCreateRequest) (View, *_nethttp.Response, error) {
	var (
...
// importRequest
func (r ViewApiApiImportViewRequest) ImportRequest(importRequest string) ViewApiApiImportViewRequest {
	r.importRequest = &importRequest
	return r
}
// type
func (r ViewApiApiImportViewRequest) Type_(type_ string) ViewApiApiImportViewRequest {
	r.type_ = &type_
	return r
}
