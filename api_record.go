...
// createRecords
func (r RecordApiApiCreateRequest) CreateRecords(createRecords []SetRecord) RecordApiApiCreateRequest {
...
// deleteRecord
func (r RecordApiApiDeleteRequest) DeleteRecord(deleteRecord DeleteRecord) RecordApiApiDeleteRequest {
...
// updateRecords
func (r RecordApiApiUpdateRequest) UpdateRecords(updateRecords []SetRecord) RecordApiApiUpdateRequest {
	r.updateRecords = &updateRecords
	return r
}
...
func (a *RecordApiService) UpdateExecute(r RecordApiApiUpdateRequest) ([]Record, *_nethttp.Response, error) {
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.updateRecords == nil {
		return localVarReturnValue, nil, reportError("updateRecords is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateRecords
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
// updateRecord
func (r RecordApiApiUpdateRecordRequest) UpdateRecord(updateRecord SetRecord) RecordApiApiUpdateRecordRequest {
	r.updateRecord = &updateRecord
	return r
}
// path
...
func (a *RecordApiService) UpdateRecordExecute(r RecordApiApiUpdateRecordRequest) (Record, *_nethttp.Response, error) {
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.updateRecord == nil {
		return localVarReturnValue, nil, reportError("updateRecord is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateRecord
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
