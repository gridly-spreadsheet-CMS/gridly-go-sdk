...
// checks if the ViewStatistic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewStatistic{}
...
func (o ViewStatistic) ToMap() (map[string]interface{}, error) {
