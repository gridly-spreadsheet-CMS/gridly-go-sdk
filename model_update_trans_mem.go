...
// checks if the UpdateTransMem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTransMem{}
...
func (o UpdateTransMem) ToMap() (map[string]interface{}, error) {
